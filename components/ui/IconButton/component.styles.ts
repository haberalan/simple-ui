...
const IconButtonStyles = styles(
  'relative font-500 aspect-square rounded-1 transition-all duration-200 ease-in-out hover:shadow-sm flex items-center justify-center disabled:pointer-events-none',
  {
    variant: {
      primary:
      ...
      quaternary: 'hover:dark:text-gray-100 hover:bg-gray-200 hover:dark:bg-gray-800 disabled:text-gray-700',
    },
    size: {
      sm: 'p-1',
      md: 'p-2',
