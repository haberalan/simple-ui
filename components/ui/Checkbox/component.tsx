      ...
      <div className="relative flex items-center justify-center">
        ...
        <AnimatePresence>
          {props.checked && (
            ...
            >
              <Icon name="Check" className={IconStyles({ disabled: !!props.disabled, checked: props.checked })} />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
