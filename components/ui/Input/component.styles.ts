...
const InputStyles = styles(
  ...
  {
    status: {
      default: 'bg-white dark:bg-gray-1000 focus-visible:border-gray-500 focus-visible:dark:border-gray-600',
      error: 'bg-white dark:bg-gray-1000 border-error-700 dark:border-error-900 text-error-600 dark:text-error-500',
      disabled: 'bg-gray-200 text-gray-400 dark:bg-gray-900 dark:text-gray-700',
      valid: 'bg-white dark:bg-gray-1000 focus-visible:border-gray-500 focus-visible:dark:border-gray-600',
    },
    icon: {
      left: 'pl-8',
      right: 'pr-8',
...
const IconStyles = styles(
  'select-none pointer-events-none h-5 w-5 absolute bottom-2 transition-colors duration-150 ease-in-out',
  {
    status: {
      ...
      error: 'text-error-700 hover:text-error-600 dark:text-error-600 hover:dark:text-error-500',
