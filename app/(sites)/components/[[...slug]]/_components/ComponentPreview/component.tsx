  ...
  return (
    <section className="flex flex-col gap-4">
      <Tabs labels={["Preview", "Code"]} variant="secondary">
        ...
        <TabItem label="Code">
          <div className="scrollbar max-h-[400px] overflow-auto rounded-2 border border-gray-300 bg-grid-light px-2 py-4 font-sans dark:border-gray-900 dark:bg-grid-dark">
            <SyntaxHighlighter
              language="typescript"
              style={style}
              customStyle={{
